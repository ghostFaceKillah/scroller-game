...
@interface TowerUpperPart()
@property BOOL isAttacking;
@end

@implementation TowerUpperPart

+(TowerUpperPart *) spawn
{
    // alloc and init monster goblin
    TowerUpperPart *monster = [[TowerUpperPart alloc] init];
    monster.sprite = [SKSpriteNode spriteNodeWithImageNamed:@"tower_up_placeholder.png"];
